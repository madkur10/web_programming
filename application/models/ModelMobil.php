...
{     //manajemen mobil     
    ...
    //manajemen kategori     public function getKategori()     {         return $this->db->get('kategori');     }  
    ...
    {
        $this->db->select('mobil.kategori_id,kategori.kategori_name');
        $this->db->from('mobil');
        $this->db->join('kategori', 'kategori.kategori_id = mobil.kategori_id');
        $this->db->where($where);
        return $this->db->get();
    }
}
